...
def init_rotate_motor(port, brand, model, motor_idx_des, baudrate_des):
    if brand == "feetech":
    ...
    try:
        ...
        if brand == "feetech":
            print("=== Feetech motor configuration is complete.")
...
if __name__ == "__main__":
    ...
    init_rotate_motor(args.port, args.brand, args.model, args.ID, args.baudrate)